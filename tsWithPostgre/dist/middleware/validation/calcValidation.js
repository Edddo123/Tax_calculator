...
exports.corpVATSchema = exports.personVATSchema = exports.IncomecalcSchema = void 0;
...
exports.personVATSchema = joi_1.default.object({
    sales: joi_1.default.number().positive().required()
});
exports.corpVATSchema = joi_1.default.object({
    sales: joi_1.default.number().positive().required()
});
